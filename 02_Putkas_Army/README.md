...
- **Domain expertise in the prompts.** Construct-specific inclusion rules and statistical extraction instructions are injected into both the per-PDF extraction prompt and the batched aggregation prompt.
