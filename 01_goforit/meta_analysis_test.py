...
def main():
    ...
    parser.add_argument(
        "--outcsv", default="submission_qc.csv",
        help="Output submission CSV path (default: submission_qc.csv).",
    )
    parser.add_argument(
        "--outdir", default="output_test_qc",
        help="Folder for per-study result files (default: output_test_qc/).",
    )
    parser.add_argument(
